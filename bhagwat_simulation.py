    ...
    while round(i,3) != line.L+step:
        ...
        if temp != None:
            ...
            if fluid_simulation.P > PB:
                ...
                vsg,vsl,vm,Hl,mix_rho,mix_viscosity,C0,vd = drift_infos_bha(flow_info,line)
                ...
                vars[8].append(round(flow_info.z, 3))
                vars[9].append(round(gravitational_gradient_Bha(flow_info, line), 3))
                vars[10].append(round(frictional_gradient_Bha(flow_info, line), 3))
                vars[11].append(round(kinetic_gradient_Bha(flow_info, line), 3))
...
def bhagwat_simulation_pump( fluid, line, temp, ) -> tuple:
