...
line1 = pipe(Dh = 3* 0.0254, e =  0.0005 * 0.0254, L = 1828.28 , angle = 90 ,direction='Ascendente' )
...
P1,T1,var1,pump1 = single_simulation(fluid,lines,temps,pump_LINE,'Beggs_Brill')
